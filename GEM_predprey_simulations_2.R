...
paramsets[[1]] <- c(K=200, a0=0.001, e=2.5, m=1, d=1)
paramsets[[1]] <- c(K=150, a0=0.001, e=1.5, m=0.5, d=1)
paramsets[[1]] <- c(K=100, a0=0.001, e=0.5, m=0.1, d=1)
paramsets[[1]] <- c(K=50, a0=0.001, e=0.2, m=0.02, d=1)


## We'd like to keep this

out <- predprey_GEM(seed=55887, tmax=100, dt=0.1, initialstate=c(C=250,P=0.2*Peq), traitmean=4, traitcv=0.2, h2=0.85, params=params, report=T)
