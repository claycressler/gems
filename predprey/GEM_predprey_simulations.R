...
## Ignore all of the text between the braces in favor of running the content outside the braces. Inside the braces is my exploration of the dynamics of this model. I discovered from these simulations that the predator-prey system has a tendency to oscillate (unsurprisingly), and that stochasticity will tend to amplify that tendency (also unsurprisingly). Thus it is important to choose parameters such that this tendency is minimized. That happens outside of the braces. But I am preserving the content inside the braces for my own record.
run <- FALSE
if (run) {
