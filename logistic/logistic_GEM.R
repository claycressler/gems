...
## Model with culling: X = culling rate
...
## the many-slice GEM
## Change this: choose an individual based on the *sum* of all possible events that could happen to that individual
## Then choose what happens to that individual based on the inidividual events
## See Claussen et al. 2007 for an example of how they implemented the algorithm
